...
const CLICKABLE_SQUARES: ClickableSquare[] = [
  { row: 2, col: 0, text: "After 30 seconds, this square will be filled for the first time. I hope you are still on this page to see it happen! Click some of the next squares to see how long it will take for them." },
  ...
  { row: 8, col: 1, text: "If you left now and walked at ~5km/h, you could walk the entirety of France's land border in these 32 days." },
  ...
  { row: 20, col: 0, text: "Uranus' moon Desdemona will most likely have collided with another of its inner moons, either Cressida or Juliet, in the next 98.1 million years."},
